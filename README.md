...
Các hạng mục sẽ được phân chia theo [teachyourselfcs](https://teachyourselfcs.com/). Các tài nguyên sẽ được chọn dưới hai kiểu chính:
...
- [Languages and Compilers](#ngôn-ngữ-và-trình-biên-dịch)
- [Distributed Systems](#hệ-thống-phân-tán)

### 3. Các chủ đề mở rộng
- [Trí tuệ nhân tạo](#trí-tuệ-nhân-tạo)
- [Tự học riêng từng ngôn ngữ lập trình](#ngôn-ngữ-lập-trình)
- [Bảo mật](#bảo-mật)
- [Hệ thống](#hệ-thống)
